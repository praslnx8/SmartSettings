...
class SmartSettingChooserActivity : AppCompatActivity() {

    companion object {

        const val SMART_SETTING_SELECTED_STR = "smart_setting_selected"

        fun open(activity: Activity, reqCode: Int) {
            val intent = Intent(activity, SmartSettingChooserActivity::class.java)
    ...
    private fun getItemView(name: String, smartSettingType: SmartSettingType): View {
        ...
        rootLayout.setOnClickListener {
            ...
            resultIntent.putExtra(SMART_SETTING_SELECTED_STR, smartSettingType.value)
